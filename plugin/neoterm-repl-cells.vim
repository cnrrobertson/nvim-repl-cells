...
command! TREPLVisualSelectCell lua require'neoterm-repl-cells'.visual_select_cell(vim.g.neoterm_repl_cell_marker)
...
command! TREPLSplitCell lua require'neoterm-repl-cells'.split_cell(vim.g.neoterm_repl_cell_marker)
command! TREPLMergeCellBelow lua require'neoterm-repl-cells'.merge_cell_below(vim.g.neoterm_repl_cell_marker)
command! TREPLMergeCellAbove lua require'neoterm-repl-cells'.merge_cell_above(vim.g.neoterm_repl_cell_marker)
